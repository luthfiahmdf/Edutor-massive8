...
const dataAccordion = [
  {
    id: 1,
    title: 'Part 1 (Introduction to Decision Making)',
    desc: 'desc 1',
  },
  {
    id: 2,
        ...
        <div className="container mx-auto my-10">
          <div className="grid max-w-screen-xl mx-auto sm:max-w-xl md:max-w-5xl mt-20">
            <div className="relative w-full" style={{ paddingTop: '56.25%' }}>
              <iframe title="YouTube Video" className="absolute inset-0 w-full h-full object-cover mt-10 rounded-md" src="https://www.youtube.com/embed/sGL0EgrDr60" frameBorder="0" allowFullScreen></iframe>
            </div>
          </div>
          <div className="lg:col-span-3 xl:col-span-3 text-center text-white mt-16">
            <h1 className="font-bold text-3xl">The importance of decision making in leadership</h1>
            <p className="font-bold text-2xl">Part 1 (Introduction to Decision Making) 1/8 </p>
          </div>
