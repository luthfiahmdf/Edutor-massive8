              ...
              <div className="grid grid-cols-3 gap-8 justify-items-center mt-16">
                ...
                <div className="flex items-center border border-white py-1 px-15">
                  ...
                  <div className="ml-4 p-5">
                    ...
                    <br />
                    <Link to="/service/softskill/leadership" className="inline-block border border-white font-semibold text-white py-1 px-6 rounded hover:text-gold w-auto">
                      Profile
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex items-center border border-white py-1 px-15">
                  ...
                  <div className="ml-4 p-5">
                    ...
                    <p className="text-sm text-white">10+ Online Video</p>
                    <br />
                    <a href="#" className="inline-block border border-white font-semibold text-white py-1 px-6 rounded hover:text-gold w-auto">
                      Profile
                    </a>
                  </div>
                </div>
