        ...
        <div className="container mx-auto my-10">
          ...
          <div className="grid max-w-screen-xl  mx-auto gap-8 lg:grid-cols-2 xl:grid-cols-2 items-center">
            ...
            <div className="lg:col-span-1 xl:col-span-1 mt-16">
              ...
              <div className="mt-5">
                <a href="#" className="inline-block border border-white font-semibold text-white py-1 px-2 rounded block hover:text-gold w-auto">
                  Enroll Now
                </a>
              </div>
            </div>
          ...
          <div className="bg-black py-24 sm:py-12">
            <div className="container mx-auto">
              <h2 className="text-4xl font-bold mb-8 text-left text-white">Other Course</h2>
              ...
              <div className="mt-10 text-white text-left">
                <a href="#" className="inline-block bg-black border border-white font-semibold text-white py-2 px-8 rounded block hover:text-gold w-auto">
                  Back
                </a>
              </div>
            </div>
